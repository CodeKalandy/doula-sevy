<?php
// Inclusion optionnelle du contenu dynamique (nom du site, etc.)
$site_nom = "Lumière de Vie Doula Sévy";
$site_url = "https://www.lumiere-de-vie-doula.fr"; // À adapter
?>
<!DOCTYPE html>
<html lang="fr">
<head>
  ...
  <title>Mentions légales – Lumière de Vie Doula Sévy</title>
  <meta name="robots" content="noindex"/>
  <link href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,300;0,400;0,500;1,300;1,400&family=Jost:wght@300;400;500&display=swap" rel="stylesheet"/>
  <style>
    :root{
      --taupe:#a08878;--taupe-light:#c4aa9a;--taupe-dark:#7a6156;
      --cream:#f5efe8;--cream-dark:#ede3d8;--red:#c0392b;
      --white:#fdfaf6;--text:#4a3a32;--text-mid:#7a6558;
    }
    *{box-sizing:border-box;margin:0;padding:0;}
    ...
    /* NAV */
    nav{position:fixed;top:0;left:0;right:0;z-index:100;display:flex;align-items:center;justify-content:space-between;padding:1.2rem 4rem;background:rgba(253,250,246,.92);backdrop-filter:blur(12px);border-bottom:1px solid rgba(160,136,120,.15);}
    ...
    .nav-back{font-size:.78rem;letter-spacing:.12em;text-transform:uppercase;color:var(--text-mid);text-decoration:none;display:flex;align-items:center;gap:.5rem;transition:color .2s;}
    ...
    .page-hero .label{font-size:.72rem;letter-spacing:.22em;text-transform:uppercase;color:rgba(255,255,255,.65);margin-bottom:.8rem;}
    .page-hero h1{font-family:'Cormorant Garamond',serif;font-size:clamp(2.2rem,4vw,3.5rem);font-weight:300;color:var(--white);line-height:1.15;}
    .page-hero h1 em{font-style:italic;color:rgba(255,255,255,.75);}
    .floral-deco{position:absolute;opacity:.18;pointer-events:none;}
    .floral-deco.left{top:40px;left:60px;width:180px;transform:rotate(-10deg);}
    .floral-deco.right{bottom:20px;right:60px;width:160px;transform:rotate(12deg) scaleX(-1);}
    ...
    .ml-section:target{scroll-margin-top:90px;}
    .ml-section h2{
    ...
    .ml-section h2 .num{
      ...
      font-size:.78rem;flex-shrink:0;font-style:normal;
    }
    .ml-section p{font-size:.92rem;line-height:1.85;color:var(--text-mid);font-weight:300;margin-bottom:.9rem;}
    ...
    /* DROITS TABLE */
    .droits-grid{display:grid;grid-template-columns:1fr 2fr;gap:.8rem;margin-bottom:1rem;}
    .droit-row{display:contents;}
    .droit-key{background:var(--cream);padding:.7rem 1rem;border-radius:4px;font-size:.82rem;font-weight:500;color:var(--taupe-dark);display:flex;align-items:center;}
    .droit-val{background:var(--cream-dark);padding:.7rem 1rem;border-radius:4px;font-size:.82rem;color:var(--text-mid);font-weight:300;display:flex;align-items:center;}
    ...
    .page-footer p{font-size:.75rem;color:rgba(255,255,255,.3);margin-top:.5rem;}
...
<div class="content-wrap">
  ...
  <div class="ml-section" id="mentions">
    ...
    <div class="info-box">
      ...
      <p><strong>Email de contact :</strong> <a href="mailto:lumieredevie.doulasevy@gmail.com" style="color:var(--taupe);">lumieredevie.doulasevy@gmail.com</a> <em style="font-size:.8rem;color:var(--taupe-light)"></em></p>
    </div>
  ...
  <div class="ml-section" id="droits">
    ...
    <p>Pour exercer ces droits, contactez-nous à : <a href="mailto:lumieredevie.doulasevy@gmail.com" style="color:var(--taupe);">lumieredevie.doulasevy@gmail.com</a> <em style="font-size:.8rem;color:var(--taupe-light)"></em><br/>
  ...
  <div class="ml-section" id="loi">
    ...
    <a href="mailto:lumieredevie.doulasevy@gmail.com" style="color:var(--taupe);font-weight:500;">lumieredevie.doulasevy@gmail.com</a> <em style="font-size:.8rem;color:var(--taupe-light)"></em></p>
  </div>

  <p style="font-size:.78rem;color:var(--taupe-light);text-align:right;margin-top:3rem;font-style:italic;">
...
<div class="page-footer">
  <a href="index.php">Lumière de Vie – Doula Sévy ♥</a>
